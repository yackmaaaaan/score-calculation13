...
const CORE=["./","./index.html","./style.css?v=25","./app.js?v=25","./manifest.json?v=25","./app-icon-32-v17.png","./app-icon-192-v17.png","./app-icon-512-v17.png","./title-calculator-v9.png","./title-score-table.svg","./r5m.png","./r5p.png","./r5s.png"];
